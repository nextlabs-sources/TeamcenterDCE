...
# Recipes       :: upgrade_workflow_initial_protection
...
ruby_block 'upgrade_workflow_initial_protection' do
    block do
        log_info(LOGMSG::UPGRADE_WORKFLOW_INITIAL_PROTECTION)
        ...
        if File.exist?(des_dir)
            log_info('Update Nextlabs dll files to Teamcenter bin directory...')
