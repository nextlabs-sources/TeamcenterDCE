...
# Recipes       :: upgrade_foundation_customization
...
ruby_block 'upgrade_foundation_customization' do
    ...
    block do
        log_info(LOGMSG::UPGRADE_FOUNDATION_CUSTOMIZATION)
        ...
        call_system_command('Regenerate client meta cache', 'generate_client_meta_cache', exe_cmd, :no)
    end
end
