...
//import com.nextlabs.teamcenter.fms.test.RepeatTest;
//import com.nextlabs.teamcenter.fms.test.RepeatedTestRule;
 ...
 * 
 * @author clow
 * Test cases for plaintext JT file and encrypted JT file
 ...
 * 9. Assert random access case 9, fileoffset: 36502224, off: 0, len: 1024000
 *
 */

public abstract class AbstractJtFileTest {

	//@Rule
	//public RepeatedTestRule repeatRule = new RepeatedTestRule();
	
	private File plaintextFile = new File(JT_PLAINTEXTFILE_PATH);
	private File encryptedFile = new File(JT_ENCRYPTEDFILE_PATH);
	 ...
	 * fileoffset: 36502224, off: 0, len: 1024000
	 */
	@Test
	//@RepeatTest(times = 1)
