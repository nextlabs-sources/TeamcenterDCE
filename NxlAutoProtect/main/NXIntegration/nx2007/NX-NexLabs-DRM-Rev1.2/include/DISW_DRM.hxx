    ...
    namespace DRM
    {
        ...
        namespace Adaptor
        {
            ...
            public:
                ...
                //
                // The DRM adaptor should implement this method to populate and return DRM permissions
                // on the file.
                // IAccessControl::GetFilePermissions will be called by NX after successful part load.
                // Methods are provided on IFilePermissions interface to add/remove file permissions.
                // NX will cache the returned file permissions which will be used later in the 
                // NX workflows like Save, Export, Print etc. to check the permissions on the part file.
                // Should return S_OK(0) if success else return error code.
                //
                ...
                //
                // The DRM adaptor should implement this method to return the error code 
                // for the provide operation on the part file.
                // In NX workflows like Save, Export, Print etc. when the necessary permission for
                // that operation is not present in the cached permissions for the part file,
                // NX will call IAccessControl::GetErrorCodeForOperation to get the error code
                // for the operation.
                // This error code will be used by NX later to get the 
                // localized error message from the DRM adaptor,
                // so that the DRM adaptor defined error message can be shown to the user.
                //
                virtual int GetErrorCodeForOperation
                (
                    DISW::DRM::Adaptor::FileOperation operationType
                ) = 0;
        ...
        {
            //
            // This enum defines the DRM permissions present on the file.
            //
            ...
            //
            // DISW::DRM::Host::IFilePermissions interface will be provided by NX.
            // This interface object will be passed to IAccessControl::GetFilePermissions method.
            // Methods are provided to add/remove file permissions.
            //
            class IFilePermissions
            {
            ...
            public:
                ...
                virtual bool AddPermission(DISW::DRM::Host::FilePermission permission) = 0;

                virtual bool RemovePermission(DISW::DRM::Host::FilePermission permission) = 0;

                virtual bool HasPermission(DISW::DRM::Host::FilePermission permission) const = 0;
            };
