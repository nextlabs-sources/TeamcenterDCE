...
/*
	...
	FullName:	?LookupBySpec@TableEntry@PDM@UGS@@SAPEAU123@PEBD@Z
	UnDecorated:	public: static struct UGS::PDM::TableEntry * __ptr64 __cdecl UGS::PDM::TableEntry::LookupBySpec(char const * __ptr64)
	Package = UGS::PDM::TableEntry
	Versions(#Ordinal):
		1953.1700.0.0 (#3591)
*/
#define TableEntry_LookupBySpec_FULLNAME "?LookupBySpec@TableEntry@PDM@UGS@@SAPEAU123@PEBD@Z"
