...
/*
	...
	FullName:	?PVTRANS_UG_translate_assembly@@YAHIPEBD00PEAX@Z
	UnDecorated:	int __cdecl PVTRANS_UG_translate_assembly(unsigned int,char const * __ptr64,char const * __ptr64,char const * __ptr64,void * __ptr64)
	Package = PVTRANS_UG
	Versions(#Ordinal):
		12.0.2.9 (#3745)
*/
#define UG_translate_assembly_FULLNAME "?PVTRANS_UG_translate_assembly@@YAHIPEBD00PEAX@Z"
...
/*
	PX_export
	ApiName:	PX_export
	FullName:	?PX_export@@YAXPEAIHPEAD_N2H@Z
	UnDecorated:	void __cdecl PX_export(unsigned int * __ptr64,int,char * __ptr64,bool,bool,int)
	Package = PX
	Versions(#Ordinal):
		12.0.2.9 (#3853)
*/
#define PX_export_FULLNAME "?PX_export@@YAXPEAIHPEAD_N2H@Z"
