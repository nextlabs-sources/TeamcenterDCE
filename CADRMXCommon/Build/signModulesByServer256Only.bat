...
REM
REM Set default value of SIGNING_SERVER env
REM
IF "%SIGNING_SERVER%"=="" set SIGNING_SERVER=PRASLIN
set 
...
set FILE_LIST=
FOR %%i IN (*.dll *.exe *.sys *.cat *.cab *.msi *.arx) DO set FILE_LIST=!FILE_LIST! "%%i"
